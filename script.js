  ...
  modalButtons.forEach(btn => {
   ...
   function startTimer(duration, display) {
    ...
    const tick = () => {
      ...
      const minutesDisplay = display.querySelector('.minutes');
      const secondsDisplay = display.querySelector('.seconds');

      [...minutesDisplay?.children].forEach((span, index) => {
        span.textContent = minutes[index];
        console.log(minutesDisplay?.children);
      });

      [...secondsDisplay?.children].forEach((span, index) => {
        span.textContent = seconds[index];
      });
